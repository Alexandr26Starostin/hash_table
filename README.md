...
Проект написан на arch-Linux, процессор Intel N95, используется 15.4 Гб оперативной памяти, 475.9 Гб жёсткого диска. Модель ноутбука - 16-дюймовый ноутбук XISEZIUO.
